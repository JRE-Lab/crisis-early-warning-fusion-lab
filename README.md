...
- **Define a destabilisation scenario:** Describe the actor, region and time horizon of concern.
- **Plan OSINT collection:** Gather news/RSS feeds, public event databases (e.g., GDELT/ACLED substitutes), weather APIs, and economic data.
- **Ingest and normalise:** Use Python or a notebook to parse RSS feeds and API responses into a unified dataset.
